...
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', 'http://www.ppios.com/wp-content/uploads/demo.png');									// Image to serve if an error occurs instead of showing error message 
